...
export class CreateTenantUserUseCase {
    ...
    async execute(dto: CreateTenantUserDto): Promise<TenantUserPrimitives> {
        ...
        return createdTenantUser.toPrimitives();
    }
}
