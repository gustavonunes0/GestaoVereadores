...
export function PautaDetalhePanel({
    sessaoId,
    statusSessao,
    item,
    somenteLeitura,
    ...
    if (!item) {
        return (
            <section className="pauta-split__detalhe" aria-label="Detalhe do item da pauta">
                <div className="pauta-detalhe__empty">
                    <i className="pi pi-list" aria-hidden />
                    <p>
                        Selecione um item da pauta para visualizar o conteúdo e as ações
                        disponíveis.
                    </p>
                </div>
            </section>
    ...
    return (
        <section className="pauta-split__detalhe" aria-label={`Detalhe: ${titulo}`}>
            ...
            <div className="pauta-detalhe__viewer">
                <PautaItemLeitura
                    key={item.id}
                    sessaoId={sessaoId}
                    item={item}
