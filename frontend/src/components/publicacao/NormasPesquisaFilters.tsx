    ...
    >
      <div className="sessao-filters-section">
        ...
        <div className="sessao-filters-grid sessao-filters-grid--3">
          <label className="filter-field">
            <span className="filter-field__label">Espécie normativa</span>
            <select
          ...
          <label className="filter-field">
            ...
            <select value={filtros.anoId} onChange={(e) => onChange({ anoId: e.target.value })}>
      ...
      <div className="sessao-filters-section">
        ...
        <div className="sessao-filters-presets">
          ...
          <button type="button" className="btn btn-ghost btn-sm" onClick={presetAnoAtual}>
            Ano vigente
          </button>
        </div>
