          ...
          <TabPanel header="Plataforma SIGL">
            <div className="login-form-fields">
              ...
              <Password
                id="sigl-password"
                value={siglPassword}
                onChange={(e) => setSiglPassword(e.target.value)}
                feedback={false}
                toggleMask
                className="w-full"
          ...
          <TabPanel header="Câmara Municipal">
            <div className="login-form-fields">
              ...
              <Password
                ...
                onChange={(e) => setCamaraPassword(e.target.value)}
                feedback={false}
                toggleMask
                className="w-full"
                inputClassName="w-full"
              ...
              />
              <SiglButton
                label={submitting ? 'Entrando…' : 'Entrar na câmara'}
                icon="pi pi-building"
                className="w-full"
                loading={submitting}
              ...
              />
              <p className="login-hint">
                Demo: <code>admin@camara.teste</code> / <code>camara123</code> — CNPJ{' '}
                <code>00.000.000/0001-91</code>
              </p>
              <p className="login-hint login-hint--info">
                O tenant é definido pelo JWT após o login. Não envie tenantId manualmente nas
                demais telas.
              </p>
            </div>
          </TabPanel>
