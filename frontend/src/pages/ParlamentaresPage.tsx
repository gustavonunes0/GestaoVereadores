...
export function ParlamentaresPage() {
    ...
    async function handleSubmit(e: FormEvent) {
        ...
        try {
            ...
            if (creating) {
                const created = await api<ParlamentarDetalhe>(
                    '/parlamentares',
                    {
                        method: 'POST',
            ...
            await load();
            if (selectedId) {
                const d = await api<ParlamentarDetalhe>(
                    `/parlamentares/${selectedId}`,
                );
    ...
    return (
        <>
            ...
            >
                Clique em um parlamentar na tabela para abrir o cadastro no
                painel lateral. Dados pessoais, mandatos e situação na casa.
            </p>
            ...
            <NavDrawer
                ...
                subtitle={
                    creating
                        ? 'Preencha os dados e vincule mandatos à legislatura.'
                        : undefined
                }
            >
                <form
                        ...
                        <label>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setForm({
                                        ...form,
                                        nomeParlamentar: e.target.value,
                                    })
                                }
                                disabled={!canWrite}
                            ...
                            <label>
                                ...
                                <select
                                    ...
                                    onChange={(e) =>
                                        setForm({
                                            ...form,
                                            situacaoMilitar: e.target.value,
                                        })
                                    }
                                    disabled={!canWrite}
                                >
                    ...
                    <div className="form-section">
                        ...
                        {form.mandatos.length === 0 && (
                            <p className="muted" style={{ fontSize: '0.9rem' }}>
                                Nenhum mandato. Cadastre legislaturas em
                                Legislaturas e vincule aqui.
                            </p>
                        )}
                        {form.mandatos.map((m) => (
