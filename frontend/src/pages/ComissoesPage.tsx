...
export function ComissoesPage() {
    ...
    useEffect(() => {
        ...
        api<ComissaoDetalhe>(`/comissoes/${selectedId}`).then((d) =>
    ...
    return (
        <>
            ...
            >
                Clique em uma comissão na tabela para abrir o cadastro no painel
                lateral.
            </p>
            ...
            <NavDrawer
                ...
                subtitle={
                    creating
                        ? 'Dados básicos, complementares e comissão temporária.'
                        : undefined
                }
            >
                        ...
                        <label className="label-inline">
                            <input
                                ...
                                onChange={(e) =>
                                    setForm({
                                        ...form,
                                        unidadeDeliberativa: e.target.checked,
                                    })
                                }
                                disabled={!canWrite}
                            />
                        ...
                        <label>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setForm({
                                        ...form,
                                        dataHoraReuniao: e.target.value,
                                    })
                                }
                                disabled={!canWrite}
                            />
                        ...
                        <label>
                            ...
                            <input
                                ...
                                onChange={(e) =>
                                    setForm({
                                        ...form,
                                        enderecoSecretaria: e.target.value,
                                    })
                                }
                                disabled={!canWrite}
                            />
