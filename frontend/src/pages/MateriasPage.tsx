...
export function MateriasPage() {
  ...
  const permiteRepresentantes = useMemo(
    () =>
      dominios ? tipoPermiteMultiplosRepresentantes(tipoId, dominios.tiposMateria) : false,
    [tipoId, dominios],
  );
  ...
  async function handleCreate() {
    ...
    if (permiteRepresentantes && representanteIds.length === 0) {
      showApiError(
        new Error('Selecione ao menos um representante para Moção ou Requerimento.'),
      );
      return;
    }
    ...
    try {
      const base = {
        ...
        numeroProtocolo: numeroProtocolo ? Number(numeroProtocolo) : undefined,
        ...
        body: JSON.stringify(
          isProjetoLei
            ? {
                ...
                coautorIds: coautorIds.length ? coautorIds : undefined,
        ...
        {dominios && (
          <div className="form-stack form-stack--sigl">
            ...
            <div className="form-grid-2">
              ...
              <div>
                <label htmlFor="mat-protocolo">Nº protocolo</label>
                <InputText
                  id="mat-protocolo"
            ...
            <Dropdown
              id="mat-ano"
              value={anoId}
              options={[emptyOption, ...dominios.anos.map((a) => ({ id: a.id, nome: String(a.valor) }))]}
              optionLabel="nome"
              optionValue="id"
            ...
            <Dropdown
              ...
              className="w-full"
            />
            <label htmlFor="mat-data-ap">Data de apresentação</label>
            <InputText
              id="mat-data-ap"
              type="date"
            ...
            <p className="form-section-label">Autoria e representação</p>

            {isProjetoLei && (
              <>
                <label htmlFor="mat-autor-pl">Autor (vereador) *</label>
                <Dropdown
                  id="mat-autor-pl"
                  ...
                  optionLabel="nome"
                  optionValue="id"
                  onChange={(e) => setAutorParlamentarId(e.value)}
                  className="w-full"
                />
                ...
                <MultiSelect
                  id="mat-coautores"
                  value={coautorIds}
                  options={parlOptions.filter((p) => p.id !== autorParlamentarId)}
                  optionLabel="nome"
                  optionValue="id"
            ...
            {!isProjetoLei && (
              <>
            <label htmlFor="mat-autor">Autor (cadastro)</label>
            <Dropdown
              id="mat-autor"
              value={autorId}
            ...
            {permiteRepresentantes && (
              <>
                ...
                <MultiSelect
                  ...
                  optionLabel="nome"
                  optionValue="id"
                  onChange={(e) => setRepresentanteIds(e.value ?? [])}
            ...
            <Dropdown
              id="mat-status-tram"
              value={statusId}
              options={[emptyOption, ...dominios.statusTramitacao]}
              optionLabel="nome"
              optionValue="id"
            ...
            <Dropdown
              ...
              options={[emptyOption, ...dominios.unidadesTramitacao]}
              optionLabel="nome"
              optionValue="id"
              onChange={(e) => setUnidadeTramitacaoId(e.value)}
              className="w-full"
            />
            <label htmlFor="mat-local-ext">Local origem externa</label>
            <Dropdown
              id="mat-local-ext"
              value={localOrigemExternaId}
              options={[emptyOption, ...dominios.locaisOrigemExterna]}
              optionLabel="nome"
              optionValue="id"
